...
if ($_SERVER['REQUEST_METHOD']==='POST' && ($_POST['action'] ?? '') === 'upload_detect') {
...
if ($_SERVER['REQUEST_METHOD']==='POST' && ($_POST['action'] ?? '') === 'terminate_one') {
...
if ($_SERVER['REQUEST_METHOD']==='POST' && ($_POST['action'] ?? '') === 'terminate_mass') {
  $items = $_POST['items'] ?? [];
